...
/**
 * Created by andruzzzhka, from the BeatSaverDownloader plugin
 * https://github.com/andruzzzhka/BeatSaverDownloader/blob/master/BeatSaverDownloader/UIFramework/BeatSaberUI.cs
 */
...
namespace DiscordCommunityPlugin
{
    class BaseUI : MonoBehaviour
    {
        ...
        public static BaseUI _instance;
        ...
        internal static void OnLoad()
        {
            ...
            new GameObject("BeatSaber Custom UI").AddComponent<BaseUI>();
        }
