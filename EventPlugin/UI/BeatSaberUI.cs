...
namespace EventPlugin.UI
{
    ...
    public static class BeatSaberUI
    {
        ...
        public static T CreateViewController<T>() where T : ViewController
        {
            ...
            Object.DontDestroyOnLoad(vc.gameObject);
        ...
        {
            Button button = Object.Instantiate(Resources.FindObjectsOfTypeAll<Button>().Last((Button x) => x.name == buttonTemplate), parent, false);
            ...
            button.name = "CustomUIButton";
            (button.transform as RectTransform).anchorMin = new Vector2(0.5f, 0.5f);
            (button.transform as RectTransform).anchorMax = new Vector2(0.5f, 0.5f);
