...
namespace ChristmasShared
{
    public class E
    {
        private static string e1 = "<?xml version=\"1.0\" encoding=\"utf-16\"?>" +
        ...
        private static string e2 = "<?xml version=\"1.0\" encoding=\"utf-16\"?>" +
            "<RSAParameters xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\">" +
                "<Exponent>AQAB</Exponent>" +
                "<Modulus></Modulus>" +
            "</RSAParameters>";

        public static string doE(ulong userId, string itemId, Category category)
        {
            var sr = new StringReader(e2);
            var xs = new System.Xml.Serialization.XmlSerializer(typeof(RSAParameters));
            var pubkey = (RSAParameters)xs.Deserialize(sr);

            sr = new StringReader(e1);
